...
#' \href{http://fenyi.solarobs.epss.hun-ren.hu/DPD/}{Debrecen Photoheliographic
#' Data (DPD)} sunspot catalog and the revised version of the
#' \href{http://fenyi.solarobs.epss.hun-ren.hu/GPR/}{Greenwich Photoheliographic
#' Results (GPR)} sunspot catalog. The two sources contain the records of
#' sunspots appeared during 1872--2018 (GPR for 1872--1976; DPD for 1974--2018).
#'
#' Sunspots appear in groups and have a variable lifetime. This dataset has been
#' processed to account for the \emph{births} (first observations) and
...
#'   \item{theta}{mean longitude angle \eqn{\theta \in [0, 2\pi)} of the group
#'   position.}
#'   \item{phi}{mean latitude angle \eqn{\phi \in [-\pi/2, \pi/2)} of the group
#'   position.}
#' }
#' @details The mean position of the group of sunspots is obtained by a weighted
#' average of the positions of the single sunspots by the whole spot area of the
...
#'
#' The DPD data has
#' \href{http://fenyi.solarobs.epss.hun-ren.hu/ftp/pub/DPD/README.txt}{different
#' states} of completeness and quality control. The longest span of "final
#' complete data" (no missing observation days and the data has undergone a
#' systematic quality control) is from 2005 to 2015.
#'
...
#'   \item Relabel the NOAA identifier for the sunspot group for records before
#'   1974, prefixing the "GPR" string. Otherwise, very different groups of
#'   sunspots from the two catalogs may share the same identifier.
...
#' @references Baranyi, T., Győri, L., Ludmány, A. (2016) On-line tools for
#' solar data compiled at the Debrecen observatory and their extensions with the
...
#' sunspot catalogues. \emph{Monthly Notices of the Royal Astronomical Society},
#' 465(2):1259--1273. \doi{10.1093/mnras/stw2667}
#' @examples
