...
The data used in García-Portugués, Paindaveine and Verdebout (2020) is available in the object `sunspots_births`, which is created through the script [sunspots.R](https://github.com/egarpor/rotasym/blob/master/data-raw/sunspots.R). The code snippet below reproduces the main results in the paper.
